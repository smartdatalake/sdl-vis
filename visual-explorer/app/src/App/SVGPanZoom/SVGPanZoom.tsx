...
type Props = OwnProps & sizeMe.SizeMeProps;
...
class SVGPanZoom extends React.Component<Props, State> {
    ...
    public render() {
        ...
        return (
            <div style={{ width: '100%', height: '100%' }}>
                <svg
                    viewBox={`${panningOffset.x} ${panningOffset.y} ${actualWidth * zoomFactor} ${
    ...
    private handleMouseWheel(e: React.WheelEvent<SVGSVGElement>) {
        if (this.svgNodeRef !== null) {
            ...
            if (e.deltaY > 0) {
                ...
                panningOffsetNew.x = panningOffset.x - mouseX * zoomFactorNew + mouseX * zoomFactor;
                panningOffsetNew.y = panningOffset.y - mouseY * zoomFactorNew + mouseY * zoomFactor;
            } else {
                zoomFactorNew = zoomFactor / Math.abs(1.1);

                panningOffsetNew.x = panningOffset.x + mouseX * zoomFactor - mouseX * zoomFactorNew;
                panningOffsetNew.y = panningOffset.y + mouseY * zoomFactor - mouseY * zoomFactorNew;
            }
