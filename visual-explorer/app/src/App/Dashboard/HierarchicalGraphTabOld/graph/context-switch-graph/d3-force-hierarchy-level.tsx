...
class D3ForceHierarchyLevel extends React.Component<ID3ForceHierarchyLevelProps, ID3ForceHierarchyLevelState> {
    ...
    public forceSimulationFn = memoize((currentNode: CustomHierarchyNode) => {
        ...
        this.currentChildNodes = currentNode.children ? currentNode.children : [];
        ...
        this.forceSimulation = forceSimulation<CustomHierarchyNode, SimulationLinkDatum<CustomHierarchyNode>>(
    ...
    private forceSimulation?: Simulation<CustomHierarchyNode, SimulationLinkDatum<CustomHierarchyNode>>;
    ...
    public componentDidUpdate(prevProps: ID3ForceHierarchyLevelProps, prevState: ID3ForceHierarchyLevelState) {
        this.forceSimulationFn(this.state.currentNode);
    }
