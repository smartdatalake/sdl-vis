...
import DataTable from './dynamic-table';
 ...
 */
class SampleGraphVis extends React.Component<SampleGraphVisProps, SampleGraphVisState> {
    /**
     * constructor
     *
    ...
    render() {
        return (
            <div>
                {this.state.name}
                {this.state.show && <DataTable data={this.state.data} headers={this.state.headers} />}
                {
                    <ForceGraph2D
